...
//types
import { UserNotifications_userNotifications_OrderCancelled } from '../../requests/__generated__/UserNotifications';

import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
const dotIcon = <Icon name="dots-horizontal" size={30} color="#999" />;

interface OrderCancelledRowProps {
  data: UserNotifications_userNotifications_OrderCancelled;
  actions: {
...
export const OrderCancelledRow: React.FC<OrderCancelledRowProps> = ({ data, actions }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.messageBox}>
        <Text style={{ lineHeight: 20 }}>
          ...
          <Text light> Cancelled the order</Text>
        </Text>
      </View>
