...
export const UserShopScreen: NavigationFunctionComponent = ({
  componentId,
  shopConvId,
  userId,
  shopId,
  ...
  // prettier-ignore
  console.log( 'convId', shopConvId, 'userId', userId, 'shopId', shopId, 'image', image, 'screen', screen);
  ...
  const onSend = async (messages) => {
    await apolloClient.mutate({
      ...
      variables: {
        ...
        image: screen === 'product-detail' ? image : null,
      },
    });
  };
